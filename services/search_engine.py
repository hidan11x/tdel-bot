...
COMMON_SYMBOL_ALIASES = {
    ...
    "التعاونية": ("8010.SR", "SAUDI", "التعاونية"),
    "تعاونية": ("8010.SR", "SAUDI", "التعاونية"),
    "tawuniya": ("8010.SR", "SAUDI", "Tawuniya"),
    "ملاذ": ("8020.SR", "SAUDI", "ملاذ للتأمين"),
    "ملاذ للتأمين": ("8020.SR", "SAUDI", "ملاذ للتأمين"),
    "malath": ("8020.SR", "SAUDI", "Malath Insurance"),
    "سلامة": ("8050.SR", "SAUDI", "سلامة للتأمين"),
    "سلامة للتأمين": ("8050.SR", "SAUDI", "سلامة للتأمين"),
    "salama": ("8050.SR", "SAUDI", "Salama Cooperative Insurance"),
    "ابل": ("AAPL", "US", "Apple"),
    "آبل": ("AAPL", "US", "Apple"),
    "apple": ("AAPL", "US", "Apple"),
    "تسلا": ("TSLA", "US", "Tesla"),
