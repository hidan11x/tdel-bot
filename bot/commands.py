...
BOT_COMMANDS = [
    ...
    BotCommand(command="ask", description="🔎 اسأل عن سهم"),
    BotCommand(command="vip", description="💎 مركز VIP"),
    BotCommand(command="pulse", description="⚡ نبض السوق"),
    BotCommand(command="contest", description="🏁 مسابقة اليوم"),
    BotCommand(command="sync_symbols", description="🌍 تحديث الرموز"),
