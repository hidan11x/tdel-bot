...
ALIASES = {
    ...
    "8010.SR": ["التعاونية", "تعاونية", "tawuniya", "the company for cooperative insurance", "8010"],
    "8020.SR": ["ملاذ", "ملاذ للتأمين", "malath", "malath insurance", "8020"],
    "8050.SR": ["سلامة", "سلامة للتأمين", "salama", "salama insurance", "8050"],
