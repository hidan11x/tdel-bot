...
SAUDI_SYMBOLS = [
    ...
    # التأمين
    ("8010.SR", "8010.SR", "التعاونية", "Tawuniya", "التأمين", "SAUDI"),
    ("8020.SR", "8020.SR", "ملاذ للتأمين", "Malath Insurance", "التأمين", "SAUDI"),
    ("8030.SR", "8030.SR", "درع العرب", "Arab Shield", "التأمين", "SAUDI"),
    ("8040.SR", "8040.SR", "السعودية الهندية", "Saudi Indian", "التأمين", "SAUDI"),
    ("8050.SR", "8050.SR", "سلامة للتأمين", "Salama Cooperative Insurance", "التأمين", "SAUDI"),
